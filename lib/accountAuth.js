...
export function getNextRewardTap(account, cycleNumber, afterTap = 0) {
  ...
  for (const item of timeline) {
    ...
    if (nextRewardTap === null || itemTap < nextRewardTap) {
      nextRewardTap = itemTap;
    }
  }

  return nextRewardTap;
}
...
export function getTapSyncMeta(account) {
  ...
  const nextRewardTap = getNextRewardTap(account, currentCycle, currentTapInCycle);
